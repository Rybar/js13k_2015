...
G.killParticle = function(e){
    e.dead = true;
    e.xx = -100;
    e.yy = -100;
    G.Entity.prototype.die(e);
	//G.PARTICLES.splice[G.PARTICLES.indexOf(e), 1];
	//G.Entity.prototype.die(e);
};

G.makeParticle = function(params){
	//var deadpool= G.PARTICLES.filter(function(e){return e.dead = true});
